...
const MOCK_DATA: NormalisedTrademark[] = [
  // Real, well-known AU mark — Parmalat's "PAULS" dairy brand. Class 29.
  {
    ...
    regDate: "1991-07-23",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200001/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200002",
    ...
    regDate: "1997-03-18",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200002/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200003",
    ...
    regDate: "2013-08-29",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200003/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200004",
    ...
    regDate: "2009-04-30",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200004/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200005",
    ...
    regDate: "2003-12-05",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200005/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200006",
    ...
    regDate: null,
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200006/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200007",
    ...
    regDate: "1999-11-17",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200007/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200008",
    ...
    regDate: "2019-10-14",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200008/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200009",
    ...
    regDate: "1972-05-30",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200009/details",
    rawData: { mock: true },
  },
  {
    id: "AU-MOCK-200010",
    ...
    regDate: "2010-12-02",
    jurisdiction: "AU",
    externalUrl: "https://search.ipaustralia.gov.au/trademarks/search/view/200010/details",
    rawData: { mock: true },
  },
];
